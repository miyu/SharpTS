...
export class Vehicle {
   public constructor_SharpJs_Overload_0() { return console.log("Vehicle"); }
...
export class Car extends Vehicle {
   public constructor_SharpJs_Overload_0() { return console.log("Car"); }
